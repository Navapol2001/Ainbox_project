...
class QuotaCheck:
    ...
    def check_status(self,page_id) -> bool:
        """Check Status of bot"""
    ...
    def check_quota(self, page_id: str) -> Union[bool, None]:
        """
        ...
        quota_doc = collection.find_one({
            "page": {"$elemMatch": {"page_id": page_id}}
        })
    ...
    def decrease_quota(self, page_id: str) -> bool:
        """
